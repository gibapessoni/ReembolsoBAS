...
namespace ReembolsoBAS.Migrations
{
    ...
    [Migration("20250620121518_AnexosLancamento")]
    partial class AnexosLancamento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReembolsoBAS.Models.ReembolsoDocumento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReembolsoLancamentoId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ReembolsoLancamentoId");

                    b.ToTable("ReembolsoDocumentos");
                });
            ...
            modelBuilder.Entity("ReembolsoBAS.Models.ReembolsoDocumento", b =>
                {
                    b.HasOne("ReembolsoBAS.Models.ReembolsoLancamento", "Lancamento")
                        .WithMany("Documentos")
                        .HasForeignKey("ReembolsoLancamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
